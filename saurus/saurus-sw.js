...
const version = '20220116-0001';
const staticCacheName = version + 'static';
const pagesCacheName = 'pages';
const imagesCacheName = 'images';
const maxPages = 1; // Maximum number of pages to cache
const maxImages = 10; // Maximum number of images to cache
...
function updateStaticCache() {
	...
	.then( staticCache => {
		...
		return staticCache.addAll([
			'/saurus/images/dino_1.jpeg',
			'/saurus/images/dino_2.jpeg',
			'/saurus/images/dino_3.jpeg',
			'/saurus/images/dino_4.jpeg',
			'/saurus/images/dino_5.jpeg',
			'/saurus/images/dino_6.jpeg',
			'/saurus/images/dino_7.jpeg',
			'/saurus/images/dino_8.jpeg',
			'/saurus/images/dino_9.jpeg',
			'/saurus/images/dino_10.jpeg',
			'/saurus/images/dino_11.jpeg'
		]);
	});
}
		...
		event.respondWith(
			new Promise( resolveWithResponse => {
				...
				.catch( fetchError => {
					...
					.then( responseFromCache => {
						resolveWithResponse(
							responseFromCache || caches.match('/saurus/index.html')
						);
					});
				});
